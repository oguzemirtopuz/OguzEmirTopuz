...
*   **[Deal Hunter (Live Web Application)](https://github.com/oguzemirtopuz/deal-hunter):** A hyper-fast, dark-themed React/Vite web platform that aggregates the highest real-time game discounts from Steam and Epic Games. Features custom glassmorphism UI, localized TR pricing algorithms, historic price insights, and alert systems—all operating without a backend architecture.
