...
*   **[Deal Hunter (Live Web Application)](https://github.com/oguzemirtopuz/deal-hunter):** A hyper-fast, dark-themed React/Vite web platform that aggregates and filters the highest real-time game discounts from Steam and Epic Games. Designed with a custom glassmorphism UI and dynamic budget filtering algorithms without requiring any backend architecture.
    > *Tech Stack: React, Vite, Vanilla CSS, CheapShark API*
*   **[SuperArmor PDF Generator](https://github.com/oguzemirtopuz/SuperArmor-PDF-Generator):** A serverless, zero-latency autonomous exam preparation ecosystem. Ingests raw YouTube transcripts and MEB scenario images via Groq Vision API, leveraging Groq API (Llama 3.3 70B) to engineer elite pedagogical "Super Armor" PDF notes with dynamically highlighted trap zones and strategic reflexes.
